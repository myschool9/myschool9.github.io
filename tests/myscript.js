...
/*	document.getElementById('correctCount').hidden = c <= 1; */
	if (c > 1) {
...
function CheckInput(num) {
	...
	alert(document.getElementById('radio' + String(num)).checked);
}
function Check(num) {
	document.getElementById('radio' + String(num)).checked = !document.getElementById('radio' + String(num)).checked;
	alert('div' + document.getElementById('radio' + String(num)).checked);
...
function Exit() {
	...
	document.getElementById('percent').innerText = String(Math.round(p) + '%');
