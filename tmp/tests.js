...
function Next() {
	...
	document.getElementById("answer0").style.backgroundColor = "var(--js-table-color)";
	document.getElementById("answer1").style.backgroundColor = "var(--js-table-color)";
	document.getElementById("answer2").style.backgroundColor = "var(--js-table-color)";
	document.getElementById("answer3").style.backgroundColor = "var(--js-table-color)";
	document.getElementById("answer4").style.backgroundColor = "var(--js-table-color)";
	document.getElementById("answer5").style.backgroundColor = "var(--js-table-color)";
...
function Check(num) {
	...
	if (document.getElementById("radio" + String(num)).checked) {
		document.getElementById("answer" + String(num)).style.backgroundColor = "var(--js-checked-answer-color)";
	} else {
		document.getElementById("answer" + String(num)).style.backgroundColor = "var(--js-table-color)";
	}
...
function Exit() {
	...
	if (ChoiceCount() < 0.75 * test.Questions.length) {
		...
		if (m === "2+") {
			document.getElementById("mark").style.backgroundColor = "var(--js-mark-2-3)";
		}
		if (m === "4+") {
			document.getElementById("mark").style.backgroundColor = "var(--js-mark-4-5)";
		}
		if (m === "6+") {
			document.getElementById("mark").style.backgroundColor = "var(--js-mark-6-7)";
		}
		if (m === "8+") {
			document.getElementById("mark").style.backgroundColor = "var(--js-mark-8-9)";
		}
		if (m === "10+") {
			document.getElementById("mark").style.backgroundColor = "var(--js-mark-10-11)";
		}
		if (m === "12") {
			document.getElementById("mark").style.backgroundColor = "var(--js-mark-12)";
		}
	}
}